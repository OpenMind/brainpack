...
- [BrainPack Build Guide](#brainpack-build-guide)
   ...
   * [3. Assembly](#3-assembly)
      ...
      + [3.5. Thor Attachment](#35-thor-attachment)
...
* the USB-A "touch" cable to the LCD screen 
* the HDMI cable
...
<!-- TOC --><a name="33-widefield-camera"></a>
### 3.3. Widefield Camera

1. Connect the Arducam widefield camera to a computer and confirm correct focus of lens. Manually adjust the focus of lens as needed to achieve a sharp image.
