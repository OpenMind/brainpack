...
1. Ensure that the PRISM is connected to the power and ethernet cables from the Unitree Go2
2. Ensure that the PRISM is sitting securely on the Go2
3. Power on the Unitree Go2
