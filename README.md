...
The contents of this repository — including CAD models, STL files, technical drawings, bill of materials, and assembly instructions for the OpenMind BrainPack — are released by OpenMind, Inc. under the Creative Commons Attribution-NonCommercial 4.0 International License (CC BY-NC 4.0): https://creativecommons.org/licenses/by-nc/4.0/
...
No trademark rights in "OpenMind" or "BrainPack" any associated marks are granted by this license. No patent rights are granted, whether express or implied. OpenMind, Inc. retains all rights not expressly granted herein.
